...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
            ...
            <div>
                <a class="navbar-brand brand-logo" href="/Content/index.html">
                <img src="/Content/images/logo.svg" alt="logo" />
                </a>
                <a class="navbar-brand brand-logo-mini" href="/Content/index.html">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="countDropdown">
                    ...
                    <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                        <img src="/Content/images/faces/face10.jpg" alt="image" class="img-sm profile-pic">
                    </div>
                    <div class="preview-item-content flex-grow py-2">
                    ...
                    <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                        <img src="/Content/images/faces/face12.jpg" alt="image" class="img-sm profile-pic">
                    </div>
                    <div class="preview-item-content flex-grow py-2">
                    ...
                    <a class="dropdown-item preview-item">
                    <div class="preview-thumbnail">
                        <img src="/Content/images/faces/face1.jpg" alt="image" class="img-sm profile-pic">
                    </div>
                    <div class="preview-item-content flex-grow py-2">
                ...
                <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                    <img class="img-xs rounded-circle" src="/Content/images/faces/face8.jpg" alt="Profile image"> </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                    <div class="dropdown-header text-center">
                    <img class="img-md rounded-circle" src="/Content/images/faces/face8.jpg" alt="Profile image">
        ...
        <div class="container-fluid page-body-wrapper">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td class="py-1">
                                <img src="/Content/images/faces/face1.jpg" alt="image"/>
                                </td>
                                <td>
                                Herman Beck
                                </td>
                            ...
                            <tr>
                                <td class="py-1">
                                <img src="/Content/images/faces/face2.jpg" alt="image"/>
                                </td>
                                <td>
                                Messsy Adam
                                </td>
                            ...
                            <tr>
                                <td class="py-1">
                                <img src="/Content/images/faces/face3.jpg" alt="image"/>
                                </td>
                                <td>
                                John Richards
                                </td>
                            ...
                            <tr>
                                <td class="py-1">
                                <img src="/Content/images/faces/face4.jpg" alt="image"/>
                                </td>
                                <td>
                                Peter Meggik
                                </td>
                            ...
                            <tr>
                                <td class="py-1">
                                <img src="/Content/images/faces/face5.jpg" alt="image"/>
                                </td>
                                <td>
                                Edward
                                </td>
                            ...
                            <tr>
                                <td class="py-1">
                                <img src="/Content/images/faces/face6.jpg" alt="image"/>
                                </td>
                                <td>
                                John Doe
                                </td>
                            ...
                            <tr>
                                <td class="py-1">
                                <img src="/Content/images/faces/face7.jpg" alt="image"/>
                                </td>
                                <td>
                                Henry Tom
                                </td>
            ...
            <!-- partial:/Content/partials/_footer.html -->
            <footer class="footer">
