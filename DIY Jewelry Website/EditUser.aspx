...
<head runat="server">
    ...
    <title>Edit User - Knot Fine Co.</title>
...
<body>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Modify user details and save.</p>
    ...
    <script runat="server">
        ...
        private void LoadUser(int id)
        {
            ...
            {
                con.Open();
                string sql = "SELECT Id, FullName, EmailAddress, Username, UserType FROM userTable WHERE Id=@Id";
                using (System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand(sql, con))
                {
                    ...
                    using (System.Data.SqlClient.SqlDataReader dr = cmd.ExecuteReader())
                    {
                        if (dr.Read())
                        {
                            ...
                            ddlUserType.SelectedValue = Convert.ToString(dr["UserType"]);
                        }
                    }
                }
            }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                int id;
                if (!int.TryParse(hfId.Value, out id)) return;
                ...
                {
                    con.Open();
                    string sql = "UPDATE userTable SET FullName=@FullName, EmailAddress=@Email, Username=@Username, UserType=@UserType WHERE Id=@Id";
                    using (System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand(sql, con))
                    {
